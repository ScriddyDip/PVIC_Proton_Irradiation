...
absorber_niel_df = pd.read_csv(r"C:\Users\slamb\OneDrive\Desktop\Displacement Damage Dose\DDD\DDDCalc_2_5\sb2se3_proton_niel.csv")
dopant_list = ["Copper", "Arsenic"]
markerstyle_dict = {"Copper": "o", "Arsenic": "x" }
linestyle_dict = {"Copper": "solid", "Arsenic": "dotted" }

parameter_list = ["Median(PCE/(Control PCE))","Median(Jsc/(Control Jsc))", "Median(Voc/(Control Voc))","Median(FF/(Control FF))"]

#energies to loop over
energy_list = [650,1000,1500]
